...
- [ ] **People Data Labs (PDL) Migration** (NEW PRIORITY)
  - [ ] **Research & Planning**
  ...
  - [ ] **Implementation**
    ...
    - [ ] Implement `enrich_person(linkedin_url)` function
    - [ ] Implement `enrich_company(website)` function (Optional)
  - [ ] **Integration**
    - [ ] Update `recon_agent.py` to use PDL instead of deep recon? (Discuss)
